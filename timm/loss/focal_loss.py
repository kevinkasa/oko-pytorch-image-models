"""
Lifted from: https://github.com/mathiaszinnen/focal_loss_torch/blob/main/focal_loss/focal_loss.py
"""
...
class FocalLoss(nn.Module):
    ...
    def forward(self, x: Tensor, target: Tensor) -> Tensor:
        ...
        assert torch.all((logprobs >= 0.0) & (logprobs <= 1.0)), ValueError(
        ...
        mask = mask.view(-1)
        x = self._process_preds(logprobs)
